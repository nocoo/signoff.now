...
| 02 | [数据结构与 D1](./02-数据结构与D1.md) | 已确认（0001–0005；远端需 apply 0004/0005） |
...
| 06 | [Activity 重建与 Score 算法](./06-Activity重建与Score算法.md) | 大纲 |
| 07 | [CLI 命令矩阵与 ADO 落盘](./07-CLI命令矩阵与ADO落盘.md) | 大纲 |
