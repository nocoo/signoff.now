...
当前产品从 01 定义、10 的 PR 工作台、11 的真实 PR 采集与 13 的成员贡献统计起阅读。02–08 保留既有 Activity / Score 的设计和阶段记录；当前功能以 10、11、13 的契约为准。使用、开发和采集入口见 README。
...
| 12 | [Access 与身份契约](12-agent-access.md) | 浏览器、自动化身份和生产访问边界 |
| 13 | [成员目录与 PR 贡献统计](13-成员目录与PR贡献统计.md) | 精确账号关联、团队关系、手动统计、历史口径与来源隔离 |
