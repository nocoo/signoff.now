...
- Readiness is a persisted Jev-only judgment for watched PRs. Raw requirements retain source IDs, states and provider links. On Track never means ready to merge; see [Jev contract](19-pr-state-machines.md).
