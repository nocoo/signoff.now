/**
 * Sidebar state — Zustand store for the main content sidebar.
 *
 * Controls sidebar visibility, width, and mode (Tabs / Changes).
 * Uses zustand/persist to remember user preferences across sessions.
 */
