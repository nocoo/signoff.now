/**
 * Workspace sidebar state — Zustand store for the project/workspace list panel.
 *
 * Controls the left panel showing projects and their workspaces.
 * Supports collapsing to a narrow icon-only view (52px) and
 * per-project collapse/expand state.
 */
