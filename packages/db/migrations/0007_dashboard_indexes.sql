...
CREATE INDEX IF NOT EXISTS idx_activities_config_day_type ON activities (
	config_version,
	day_key,
	type
);
...
CREATE INDEX IF NOT EXISTS idx_ingest_runs_config_status_finished ON ingest_runs (
	config_version,
	status,
	finished_at DESC
);
